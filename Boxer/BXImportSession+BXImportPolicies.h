...
/// The \c BXImportPolicies category defines class-level helper methods that Boxer uses to decide
/// how to import games.
...
@property (class, readonly, copy) NSSet<NSString*> *installerPatterns;

/// Returns a set of likely installer name patterns in order of preference.
@property (class, readonly, copy) NSArray<NSString*> *preferredInstallerPatterns;

/// Returns whether the executable at the specified path is an installer or not.
/// Uses \c +installerPatterns:
...
@property (class, readonly, copy) NSSet<NSString*> *ignoredFilePatterns;
...
@property (class, readonly, copy) NSSet<NSString*> *junkFilePatterns;

/// Returns whether the file at the specified path should be discarded when importing.
/// Uses <code>+junkFilePatterns</code>.
...
@property (class, readonly, copy) NSSet<NSString*> *playableGameTelltalePatterns;

/// A set of filename extensions whose presence indicates the game is installed and playable.
@property (class, readonly, copy) NSSet<NSString*> *playableGameTelltaleExtensions;

/// Returns whether the file at the specified path is a telltale for an installed and playable game.
/// Uses \c playableGameTelltaleExtensions and <code>playableGameTelltalePatterns</code>, in that order.
...
/// Returns \c YES if the game at the specified URL is large enough to be considered a CD-ROM game.
