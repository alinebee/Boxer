...
WMcursor*    QZ_CreateWMCursor   (_THIS, Uint8 *data, Uint8 *mask, 
	...
	//--Modified 2009-03-16 by Alun Bestor: replace this entire worthless enterprise with the original OS X cursor image, since this behaves just as well and isn't clipped wrongly and denuded of its dropshadow
    //cursor->nscursor = [ [ NSCursor alloc ] initWithImage: img hotSpot: NSMakePoint(hot_x, hot_y) ];
	cursor->nscursor = [[NSCursor arrowCursor] retain];
	//--End of modifications
