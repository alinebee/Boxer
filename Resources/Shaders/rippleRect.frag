...
const float maxDistance = 0.05; //The ripples will extend to 10% of the total texture area
...
void main(void) {
    ...
    gl_FragColor = texture2DRect(rubyTexture, sourcePixel * rubyTextureSize);
}